...
const Footer = () => {
  return (
    <div className="bg-amber-50 p-4 mt-16 ">
      <div className="font-brand flex justify-between items-center m-8">
        <div className="flex flex-col justify-center gap-4 mx-auto">
          <h1 className="text-blue-400 font-headings text-[32px]">
            Lets get in touch!
          </h1>
        ...
        <div className="flex justify-end ">
          <a
            href="#top"
            className="bg-gray-200 p-1 w-12 h-12 flex justify-center rounded-full items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={24}
      ...
      <h1 className="font-regular">@Artvedic</h1>
    </div>
  );
};
